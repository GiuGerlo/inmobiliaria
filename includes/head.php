...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title : 'Inmobiliaria'; ?></title>
    <meta name="description" content="<?php echo isset($page_description) ? $page_description : 'Portal inmobiliario profesional'; ?>">
    <meta name="keywords" content="inmobiliaria, propiedades, casas, departamentos, terrenos">
    ...
    <header id="header" class="header d-flex align-items-center sticky-top">
        <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
            ...
            <a href="index.php" class="logo d-flex align-items-center">
                <!-- <img src="assets/img/logo.png" alt="Logo Inmobiliaria"> -->
                <h1 class="sitename">Inmobiliaria</h1>
            </a>
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    ...
                    <li><a href="vendidas">Vendidas</a></li>
